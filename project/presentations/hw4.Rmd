 ...
 *HIGHLY RECOMMEND READING* SECTIONS DESCRIBING THESE CONCEPTS IN  
 `r citeMe("gaudet_maida_2018")` and `r citeMe("qsurvey")`**
]
...
.footnote[
source: `r AutoCite(myBib, "qConv2")`
]
...
.footnote[
source: `r AutoCite(myBib, "gaudet_maida_2018")`
]
...
.footnote[
source: `r AutoCite(myBib, "rathor")`
]
...
.footnote[
source: `r AutoCite(myBib, "parcollet_morchid_linares_mori_2019")`
]
...
source: `r citeMe("parcollet_morchid_linares_mori_2019")`
]
...
# print(myBib[1:5],.opts = list(style = "html", bib.style="numeric"))
...
# print(myBib[6:8],.opts = list(style = "html", bib.style="numeric"))
