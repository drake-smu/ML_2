...
* However greats such as Maxwell even found them quite elegant and 
expressive.  
...
c_{t}&=f_{t} \times c_{t-1}+i_{t} \times \alpha\left(W_{c} \otimes x_{t}+R_{c} \otimes h_{t-1}+b_{c}\right)\\
h_{t}&=o_{t} \times \alpha\left( c_{t} \right)\\
\\
\\
&\text{Real-Valued}\\
